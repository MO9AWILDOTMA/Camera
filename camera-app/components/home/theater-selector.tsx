    ...
    const fetchTheaters = async () => {
      try {
        ...
        const mockTheaters: Theater[] = [
          { id: "1", name: "CineTix Downtown", location: "123 Main St, Downtown" },
          { id: "2", name: "CineTix Westside", location: "456 West Ave, Westside" },
          { id: "3", name: "CineTix Eastside", location: "789 East Blvd, Eastside" },
          { id: "4", name: "CineTix Northside", location: "101 North Rd, Northside" },
        ]
      ...
      <PopoverTrigger asChild>
        <Button variant="outline" role="combobox" aria-expanded={open} className="w-[200px] justify-between">
          <div className="flex items-center gap-2 truncate">
            ...
            <span className="truncate">{selectedTheater?.name || "Select Theater"}</span>
          </div>
          ...
          <CommandList>
            ...
            <CommandGroup>
              {theaters.map((theater) => (
                <CommandItem key={theater.id} value={theater.name} onSelect={() => handleSelectTheater(theater)}>
                  <Check
